...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL PRIMARY KEY, start_time timestamp with time zone, user_id int, level varchar, song_id varchar, artist_id varchar, session_id int, location text, user_agent text)""")
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS time (start_time timestamp with time zone PRIMARY KEY, hour int, day int, week int, month int, year int, weekday varchar)""")
